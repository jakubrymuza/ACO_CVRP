...
namespace CVRP_project.Algorithms
{
    internal class GreedyAntAlgorithm : BasicAntAlgorithm, IAlgorithm
    {
        ...
        public GreedyAntAlgorithm(ProblemInstance cities, int iterationsCount, int antsCount, double overLimitPenaltyFactor) : base(cities, iterationsCount, antsCount, 0, 1, 0, 0, overLimitPenaltyFactor)
        { }
